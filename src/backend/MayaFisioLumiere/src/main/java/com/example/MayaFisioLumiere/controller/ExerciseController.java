...
public class ExerciseController {
    ...
    //criar exercicios novos
    //rota http://localhost:3000/api/exercise
    ...
    //retornar os exercicios cadastrados, com paginação, para não retornar TODOS os exercicios e uma vez,
// e sim alguns por pagina e depois scrollar ou clicar no +1 pagina
    //rota http://localhost:3000/api/exercise/all?page=2&size=3,
    @GetMapping("/all")
    public ResponseEntity<List<ExerciseResponseDTO>> getExercises(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size){
    ...
    //Rota http://localhost:3000/api/exercise/searchByTitle/flexão

    // Buscar por título, ignora letra maiuscula, minuscula, acentos, consegue pesquisar por letra unica
    ...
    //procurar exercicio por id
    //rota http://localhost:3000/api/exercise/5
    @GetMapping("/{id}")
    ...
    //rota  http://localhost:3000/api/exercise/deleteExerciseId/5
