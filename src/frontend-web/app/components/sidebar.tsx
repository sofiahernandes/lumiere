...
export function Sidebar({ expanded, onToggle }: SidebarProps) {
  ...
  return (
    <aside className="panel w-full p-3 transition-all duration-300 md:min-h-[calc(100vh-2rem)]">
      ...
      >
        <div
          className={`overflow-hidden transition-[max-width,opacity] duration-200 ${expanded
        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={`overflow-hidden whitespace-nowrap transition-[max-width,opacity,transform] duration-300 ${expanded
